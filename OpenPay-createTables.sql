...
CONSTRAINT pay_payments_FK1 Foreign Key(docid) references pay_doctors,
CONSTRAINT pay_payments_FK2 Foreign Key(payorid) references pay_payors,
CONSTRAINT pay_payments_FK3 Foreign Key(paytypeid) references pay_pay_types
);
