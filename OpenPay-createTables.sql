...
constraint pay_doctorsPK Primary Key(docid)
);
...
CONSTRAINT pay_payments_docid_FK Foreign Key(docid) references pay_doctors,
CONSTRAINT pay_payments_payorid_FK Foreign Key(payorid) references pay_payors,
CONSTRAINT pay_payments_paytypeid_FK Foreign Key(paytypeid) references pay_pay_types
);
